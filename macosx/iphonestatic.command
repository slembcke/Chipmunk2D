...
# build fat library
xcodebuild -project Chipmunk6.xcodeproj -sdk iphoneos4.2 -configuration Release -target ChipmunkStatic-iPhone && \
xcodebuild -project Chipmunk6.xcodeproj -sdk iphonesimulator4.2 -configuration Debug -target ChipmunkStatic-iPhone && \
